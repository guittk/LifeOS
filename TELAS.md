...
- **Meses**: um cartão por mês, lado a lado, na ordem do calendário. Cada mês tem **Dia 10**, **Dia 20**, **Mercado Pago** e **Cartão Santander** (Estimativas / Renovação automática / Parcelas / Compras / **Aleatórios**), mais Ganhos, Gastos e Sobra do mês no rodapé.
  ...
  - Os meses são criados sozinhos: sempre há os 12 meses a partir do atual já prontos, e quando um mês termina o próximo já está lá na próxima vez que a tela abre — as contas que se repetem vêm junto, as parcelas andam uma casa (`7/12` → `8/12`) e somem quando acabam, e as compras do mês passado ficam pra trás. O botão **"+ Próximo mês"** ainda existe pra ir além desses 12, se precisar planejar mais longe.
